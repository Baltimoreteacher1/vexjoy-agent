...
```bash
python3 ~/.claude/scripts/scan-negative-framing.py --mode hype --drafts content_drafts.md
```
...
```bash
python3 ~/.claude/scripts/scan-negative-framing.py --mode cross-platform --drafts content_drafts.md
```
...
- `~/.claude/scripts/scan-negative-framing.py` — Negative framing and hype phrase detection
