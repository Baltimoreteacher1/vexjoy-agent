...
description: "Detect documentation drift against filesystem state. Use when the user wants to verify that README, docs, or CLAUDE.md still match the real repo (referenced files exist, commands/paths/counts are accurate) and flag stale or out-of-date claims."
