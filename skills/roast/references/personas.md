...
| Persona | Spec File | Focus Area | Key Concerns |
|---------|-----------|------------|--------------|
| Skeptical Senior | `references/personas/skeptical-senior.md` | Sustainability & Maintenance | Long-term viability, tech debt, operational reality |
| Well-Actually Pedant | `references/personas/pedant.md` | Precision & Accuracy | Terminology, intellectual honesty, logic gaps |
| Enthusiastic Newcomer | `references/personas/newcomer.md` | Onboarding & Accessibility | First-run experience, documentation clarity |
| Contrarian Provocateur | `references/personas/contrarian.md` | Assumptions & Alternatives | Fundamental premises, alternative approaches |
| Pragmatic Builder | `references/personas/pragmatic-builder.md` | Production Readiness | Operational concerns, edge cases, day-2 operations |
...
[Full content from this persona's spec file under `references/personas/`:
