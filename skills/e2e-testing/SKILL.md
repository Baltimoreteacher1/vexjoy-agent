---
name: e2e-testing
description: "Playwright-based end-to-end testing workflow. Use when the user wants to write, run, or debug browser end-to-end tests that drive a real web app through user flows (login, checkout, form submission) with Playwright."
