...
| ---------- | ------------------------------------------------------------------------------------------------------------------------ |
| `workflow` | Three-phase task orchestration: BRAINSTORM requirements and approaches, WRITE-PLAN with atomic verifiable tasks, EXEC... |
...
See [references/query-classification.md](research-coordinator-engineer/references/query-classification.md) for decision criteria, subagent count rules, and detection commands.
...
```text
# Spawn 3 subagents in a single message via the Agent tool
Agent(subagent_type="research-subagent-executor", description="Research compute availability", ...)
Agent(subagent_type="research-subagent-executor", description="Research semiconductor supply", ...)
Agent(subagent_type="research-subagent-executor", description="Research energy requirements", ...)
```
...
See [references/delegation-patterns.md](research-coordinator-engineer/references/delegation-patterns.md) for templates.

## Error Handling

Common research coordination errors. See [references/error-catalog.md](research-coordinator-engineer/references/error-catalog.md) for comprehensive catalog.
...
Research coordination patterns to follow. See [references/delegation-patterns.md](research-coordinator-engineer/references/delegation-patterns.md) for the anti-pattern catalog with detection commands.
...
**✅ Do instead**: Deploy all independent subagents in single message (3 Agent tool calls)
...
| ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| Query type, depth-first, breadth-first, straightforward, classify, subagent count                     | [references/query-classification.md](research-coordinator-engineer/references/query-classification.md) |
| Subagent instructions, parallel dispatch, scope boundaries, word count, deliverable format            | [references/delegation-patterns.md](research-coordinator-engineer/references/delegation-patterns.md)   |
| Error, scope creep, synthesis failure, citation in report, sequential deployment, diminishing returns | [references/error-catalog.md](research-coordinator-engineer/references/error-catalog.md)               |
