...
Load [pixi-react-integration.md](pixijs-combat-renderer/references/pixi-react-integration.md) for complete code examples.
...
Load [pixi-react-integration.md](pixijs-combat-renderer/references/pixi-react-integration.md) for sprite migration patterns.
...
- Normal map lighting → [pixi-2d-lighting.md](pixijs-combat-renderer/references/pixi-2d-lighting.md)
- Particle effects → [pixi-particle-systems.md](pixijs-combat-renderer/references/pixi-particle-systems.md)
- Post-processing → [pixi-post-processing.md](pixijs-combat-renderer/references/pixi-post-processing.md)
...
| ------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| @pixi/react setup, canvas mounting, Zustand wiring, lazy loading, Vite config                           | [pixi-react-integration.md](pixijs-combat-renderer/references/pixi-react-integration.md) |
| Normal maps, per-pixel lighting, light reactions to combat events                                       | [pixi-2d-lighting.md](pixijs-combat-renderer/references/pixi-2d-lighting.md)             |
| GPU particles, wrestling presets, DOM particle replacement                                              | [pixi-particle-systems.md](pixijs-combat-renderer/references/pixi-particle-systems.md)   |
| Bloom, vignette, chromatic aberration, color grading, mobile budgets                                    | [pixi-post-processing.md](pixijs-combat-renderer/references/pixi-post-processing.md)     |
| Custom GLSL hit filters, glow chaining, shockwave displacement, Spine animation, z-ordering, UI masking | [combat-visual-effects.md](pixijs-combat-renderer/references/combat-visual-effects.md)   |
| Sprite batching, texture atlases, RenderTexture caching, object pooling, ParticleContainer vs Container | [pixi-performance.md](pixijs-combat-renderer/references/pixi-performance.md)             |
