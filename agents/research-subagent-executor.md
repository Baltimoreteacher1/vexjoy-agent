...
- **Tool Selection Strategy**: Web research optimization with WebSearch + WebFetch loops, parallel execution patterns
...
- **100 Source Maximum**: ABSOLUTE limit - stop gathering at ~100 sources and end the turn immediately
- **Web Research Priority**: Prioritize authoritative sources and primary documentation over aggregators
- **WebFetch After WebSearch**: Core loop - use WebSearch for queries, then WebFetch for complete information
- **Manual Source Assessment**: Assess source quality manually during research
...
- **Immediate Task Completion**: End the turn as soon as research done
...
- **Parallel Web Searches**: Default to calling WebSearch in parallel rather than sequentially
...
| --------------------------------- | ---------------------------- | -------------------------------- |
| "One more search might find it"   | Diminishing returns detected | Stop and end the turn            |
...
| "Snippets are enough detail"      | Missing critical context     | Use WebFetch after WebSearch     |
...
| ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| Budget calculation, OODA structure, tool selection, query optimization, diminishing returns | [research-execution-patterns.md](research-subagent-executor/references/research-execution-patterns.md) |
| Source credibility, speculation detection, epistemic labeling, citation quality             | [source-quality-assessment.md](research-subagent-executor/references/source-quality-assessment.md)     |
